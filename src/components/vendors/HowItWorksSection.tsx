...
export function HowItWorksSection({ className }: HowItWorksSectionProps) {
  return (
    <div className={cn("", className)}>
      <h2 className="text-xl font-bold text-foreground text-center mb-10">
        How It Works
      </h2>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 lg:gap-12">
        {STEPS.map((step) => (
          <div key={step.step} className="text-center px-4">
            <div className="inline-flex items-center justify-center h-12 w-12 rounded-full bg-secondary/20 text-yellow-700 font-bold text-lg mb-4">
              {step.step}
            </div>
