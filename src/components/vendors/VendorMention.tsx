...
export const VendorMention: React.FC<VendorMentionProps> = ({
  ...
  return (
    <Link
      ...
      className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-primary/10 hover:bg-primary/20 text-primary font-medium text-sm transition-colors no-underline ${className}`}
