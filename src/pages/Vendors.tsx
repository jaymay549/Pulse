...
const WinCard = ({ 
  ...
  return (
    <div className={`relative overflow-hidden border rounded-2xl p-4 sm:p-6 shadow-sm hover:shadow-lg transition-all duration-300 group h-full flex flex-col ${styles.border} ${styles.bg}`}>
      ...
      <div className="flex items-start justify-end gap-2 mb-3 sm:mb-4">
        ...
        {isLocked ? (
          <div className="relative h-full min-h-[120px]">
            ...
            <div className="relative">
              <Quote className="absolute left-0 top-1/2 -translate-y-1/2 h-5 w-5 sm:h-6 sm:w-6 text-muted-foreground/50 group-hover:text-muted-foreground transition-colors shrink-0 mr-2" />
              <p className="text-foreground/80 text-sm sm:text-sm leading-relaxed line-clamp-4 sm:line-clamp-none blur-[6px] select-none pointer-events-none pl-7 sm:pl-8">
                "{entry.quote}"
              </p>
            </div>
          ...
          <div className="relative">
            <Quote className="absolute left-0 top-1/2 -translate-y-1/2 h-5 w-5 sm:h-6 sm:w-6 text-muted-foreground/50 group-hover:text-muted-foreground transition-colors shrink-0 mr-2" />
            <p className="text-foreground/80 text-sm sm:text-sm leading-relaxed line-clamp-4 sm:line-clamp-none pl-7 sm:pl-8">
              "{parseMarkdownWithBlur(entry.quote, showVendorNames)}"
            </p>
