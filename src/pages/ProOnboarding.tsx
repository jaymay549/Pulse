...
import { Check, Clock, Users, MessageCircle, Star, HelpCircle, Search, ArrowRight, Crown } from "lucide-react";
...
const ProOnboarding = () => {
  const [iframeSrc, setIframeSrc] = useState("https://2tqce38uozv.typeform.com/to/iSOmEde8");
  ...
  useEffect(() => {
    ...
    if (sid) {
      setIframeSrc(`https://2tqce38uozv.typeform.com/to/iSOmEde8#sid=${encodeURIComponent(sid)}`);
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-primary/5 to-secondary/10">
      <SEO 
        title="Pro Onboarding | CDG Circles - Elite Dealer Cohort Registration"
        description="Join Circles Pro and get matched with elite dealers. Private dealer chats, peer matching, and curated intelligence delivered weekly."
        ogImage="https://cdgcircles.com/og-retreat-hero.jpg"
        canonical="/pro-onboarding"
        noindex={true}
      />
      <Navigation />
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="text-center mb-12 animate-fade-in">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-secondary/20 rounded-full mb-6">
              ...
              <span className="text-secondary font-semibold">Welcome to Pro</span>
            </div>
            ...
            <p className="text-xl text-foreground/70 mb-4 max-w-2xl mx-auto">
              Complete this quick form so we can match you with your elite cohort and get you connected to the network.
            </p>
            
            <div className="inline-flex items-center gap-2 px-6 py-3 bg-primary/10 border border-primary/20 rounded-lg mb-4">
              <span className="text-lg font-bold text-primary">New Members Added Every Tuesday & Thursday</span>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
            ...
            <div className="bg-white/60 backdrop-blur-sm border border-primary/20 rounded-xl p-6 text-center animate-fade-in">
              ...
              <p className="text-sm text-foreground/70">You'll be matched with peers prior to your cohort launch to ensure optimal fit</p>
            </div>
            ...
            <div className="bg-white/60 backdrop-blur-sm border border-primary/20 rounded-xl p-6 text-center animate-fade-in">
              ...
              <p className="text-sm text-foreground/70">You'll receive an invite to the WhatsApp community when your cohort launches</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-4 mb-12 animate-fade-in" style={{ minHeight: '700px' }}>
            <iframe
              ...
              title="Pro Onboarding Form"
            />
          </div>

          {/* Vendor Intel Callout */}
          <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-2 border-yellow-300 rounded-2xl p-8 mb-8 text-center animate-fade-in">
            <Search className="w-12 h-12 text-yellow-600 mx-auto mb-4" />
            <h2 className="text-2xl font-bold text-foreground mb-3">Access Vendor Intel Now</h2>
            <p className="text-foreground/70 mb-6 max-w-2xl mx-auto">
              As a Pro member, you have immediate access to real dealer reviews on 100+ vendors — including warnings. See what your peers are saying about the tools you're evaluating.
            </p>
            <a 
              href="/vendors"
            ...
            <p className="text-xs text-foreground/50 mt-3">
              Full access included with Pro membership
              {userTier === 'pro' && (
                <span className="ml-2">
                  • <a href="https://billing.stripe.com/p/login/cN23dQ1g35Tsd3ibII" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground/70 inline-flex items-center gap-1">
                    Upgrade to Executive for priority access <Crown className="w-3 h-3" />
                  </a>
                </span>
              )}
            </p>
