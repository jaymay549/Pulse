-- Fix: column reference "vendor_name" is ambiguous in get_sales_opportunity_signals
-- The RETURNS TABLE column names clash with table column names in JOINs.
-- Fix by table-qualifying all ambiguous references in LEFT JOINs.
