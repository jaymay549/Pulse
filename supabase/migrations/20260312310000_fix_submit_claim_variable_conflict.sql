-- Fix "column reference vendor_name is ambiguous".
-- The RETURNS TABLE output column vendor_name conflicts with same-named table columns.
-- #variable_conflict use_column tells plpgsql to prefer table columns over output vars.
