-- Fix admin_ensure_vendor_profile:
-- 1. Fix NULL-safe admin check (COALESCE)
-- 2. Seed new profiles from vendor_metadata
-- 3. Clean up any test rows

DELETE FROM public.vendor_profiles WHERE vendor_name = 'test' AND user_id IS NULL;
